      ...
      message.guild.channels.cache
        ...
        .then((report) => {
          ...
          const reportEmbed = new Discord.MessageEmbed()
            ...
            .setColor("#FF9CA9")
            .setDescription(
              `${message.author} has reported ${repAuthor} (${authorID})`
            )
            .addFields(
