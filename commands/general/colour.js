...
module.exports = {
    ...
    async execute(client, message, args, Discord){
        if(!client.guilds.cache.get("848707853350862858").members.cache.get(message.member.user.id).roles.cache.has("854061604258054214")){
            if(!client.guilds.cache.get("848707853350862858").members.cache.get(message.member.user.id).roles.cache.has("868656454054342677")) return message.reply("This is a booster only feature! To access such features, boost here: discord.gg/t9yebSe7jg\n(or you can try to barter with Krazy)")
        }
